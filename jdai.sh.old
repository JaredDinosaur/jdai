    ...
    1)
        ...
        case $pkgsel in
            ...
            2)
                ...
                ;;
            3)
                pkglist="base linux linux-firmware firefox flatpak screenfetch tree htop partitionmanager plymouth grub dolphin discover plasma sddm vlc iwd git nano konsole dialog"
                ;;
            *)
